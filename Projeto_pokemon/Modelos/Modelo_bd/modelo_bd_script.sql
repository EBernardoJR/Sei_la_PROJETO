...
select Name, Type_1, Type_2 from tb_pokemon_stage;

INSERT INTO tb_pokemon_has_type (`Name`, `name_pokemon_type`)
select Name, Type_2 from tb_pokemon_stage where Type_2 is not null;

select * from tb_pokemon_type;

select * from tb_pokemon_has_type;

select count(*) from tb_pokemon_has_type;

select * from tb_pokemon_has_type where Name = 'Bulbasaur'
